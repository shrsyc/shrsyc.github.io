...
var Sentry = function(t) {
    ...
    function k(t, n) {
        ...
        var a = n ? s.getAttribute(n) : null;
        if (a) c.push("[" + n + '="' + a + '"]');
        else if (s.id && c.push("#" + s.id), (r = s.className) && y(r))
            for (i = r.split(/\s+/), u = 0; u < i.length; u++) c.push("." + i[u]);
        var f = ["type", "name", "title", "alt"];
        for (u = 0; u < f.length; u++) e = f[u], (o = s.getAttribute(e)) && c.push("[" + e + '="' + o + '"]');
        return c.join("")
    }! function(t) {
    ...
    var Mt = function() {
            ...
            return t.prototype.update = function(t) {
                if (void 0 === t && (t = {}), t.user && (t.user.ip_address && (this.ipAddress = t.user.ip_address), t.did || (this.did = t.user.id || t.user.email || t.user.username)), this.timestamp = t.timestamp || Tt(), t.ignoreDuration && (this.ignoreDuration = t.ignoreDuration), t.sid && (this.sid = 32 === t.sid.length ? t.sid : A()), void 0 !== t.init && (this.init = t.init), t.did && (this.did = "" + t.did), "number" == typeof t.started && (this.started = t.started), this.ignoreDuration) this.duration = void 0;
    ...
    var zt = function() {
            ...
            return t.prototype.captureException = function(t, n, r) {
                ...
                var e = this,
                    o = r && r.event_id,
                    u = m(t) ? this.ht().eventFromMessage(String(t), n, r) : this.ht().eventFromException(t, r);
                ...
                "string" != typeof t.release ? W.warn("Discarded session because of missing or non-string release") : (this.lt(t), t.update({
                    init: !1
                }))
                ...
                var n = this;
                return this.dt(t).then(function(r) {
                ...
                return this.jt(t, n, r).then(function(t) {
                    return t.event_id
                }, function(t) {
                    W.error(t)
                })
                ...
                var i = this,
                    ...
                    o = e.beforeSend,
                    u = e.sampleRate;
                if (!this.pt()) return jt.reject(new S("SDK not enabled, will not send event."));
                var s = "transaction" === t.type;
                return !s && "number" == typeof u && Math.random() > u ? jt.reject(new S("Discarding event because it's not included in the random sample (sampling rate = " + u + ")")) : this.bt(t, r, n).then(function(t) {
        ...
        Vt = function() {
            function t(t) {
                this.ct = t, this.ct.dsn || W.warn("No DSN provided, backend will not do anything."), this.kt = this._t()
            }
            return t.prototype.eventFromException = function(t, n) {
                ...
                this.kt.sendEvent(t).then(null, function(t) {
                    W.error("Error while sending event: " + t)
                })
            }, t.prototype.sendSession = function(t) {
                this.kt.sendSession ? this.kt.sendSession(t).then(null, function(t) {
    ...
    var nn, rn = "6.7.1",
        ...
        on = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/],
        un = function() {
            function t(n) {
            ...
            return t.prototype.setupOnce = function() {
                Nt(function(n) {
                    ...
                    if (i) {
                        ...
                        return "function" != typeof i.St ? n : i.St(n, u) ? null : n
                    }
                    return n
                })
            }, t.prototype.St = function(t, n) {
                return this.Ot(t, n) ? (W.warn("Event dropped due to being internal Sentry Error.\nEvent: " + L(t)), !0) : this.Dt(t, n) ? (W.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + L(t)), !0) : this.Tt(t, n) ? (W.warn("Event dropped due to being matched by `denyUrls` option.\nEvent: " + L(t) + ".\nUrl: " + this.Rt(t)), !0) : !this.It(t, n) && (W.warn("Event dropped due to not being matched by `allowUrls` option.\nEvent: " + L(t) + ".\nUrl: " + this.Rt(t)), !0)
        ...
        fn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|capacitor).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. \/=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
        hn = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
        vn = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
        ln = /\((\S*)(?::(\d+))(?::(\d+))\)/,
        dn = /Minified React error #\d+;/i;
    ...
    function xn(n, r, i) {
        var e = kn(r, i && i.syntheticException || void 0, {
    ...
    function jn(n, r, i, e) {
        ...
        var o = _n(r, e && e.syntheticException || void 0, {
            attachStacktrace: n.attachStacktrace
        });
    ...
    function kn(t, n, r) {
        var i, e;
        if (void 0 === r && (r = {}), d(t) && t.error) return i = gn(pn(t = t.error));
        if (p(t) || (e = t, "[object DOMException]" === Object.prototype.toString.call(e))) {
            ...
            return H(i = _n(s, n, r), s), "code" in o && (i.tags = a(a({}, i.tags), {
    ...
    var Sn = {
        ...
        On = function() {
            function n(t) {
                this.options = t, this.D = new kt(30), this.Mt = {}, this.Ct = new Jt(t.dsn, t.At, t.tunnel), this.url = this.Ct.getStoreEndpointWithUrlEncodedAuth()
            }
            return n.prototype.sendEvent = function(t) {
                ...
                this.Lt(e) && W.warn("Too many requests, backing off until: " + this.Ut(r)), s !== t.Status.Success ? u(i) : o({
                    status: s
                })
            }, n.prototype.Ut = function(t) {
                var n = Sn[t];
                return this.Mt[n] || this.Mt.all
            }, n.prototype.Ht = function(t) {
                return this.Ut(t) > new Date(Date.now())
                ...
                return !!s && (this.Mt.all = new Date(o + function(t, n) {
                    if (!n) return P;
                    var r = parseInt("" + n, 10);
    ...
    var Dn = function(t) {
            ...
            return r(n, t), n.prototype.sendEvent = function(t) {
                return this.Pt(tn(t, this.Ct), t)
            }, n.prototype.sendSession = function(t) {
                return this.Pt(Zt(t, this.Ct), t)
            }, n.prototype.Pt = function(t, n) {
                var r = this;
                if (this.Ht(t.type)) return Promise.reject({
                    event: n,
                    type: t.type,
                    reason: "Transport locked till " + this.Ut(t.type) + " due to too many requests.",
                    status: 429
                });
                var i = {
                    body: t.body,
        ...
        Tn = function(t) {
            ...
            return r(n, t), n.prototype.sendEvent = function(t) {
                ...
                var r = this;
                return this.Ht(t.type) ? Promise.reject({
                    event: n,
                    type: t.type,
                    reason: "Transport locked till " + this.Ut(t.type) + " due to too many requests.",
                    status: 429
        ...
        In = function(n) {
            ...
            return r(i, n), i.prototype.eventFromException = function(t, n) {
                ...
                if (!this.ct.dsn) return n.prototype._t.call(this);
    ...
    var qn = function() {
            function n(t) {
                this.name = n.id, this.Xt = !1, this.Bt = !1, this.ct = a({
                    onerror: !0,
                    onunhandledrejection: !0
                }, t)
            }
            return n.prototype.setupOnce = function() {
                Error.stackTraceLimit = 50, this.ct.onerror && (W.log("Global Handler attached: onerror"), this.Jt()), this.ct.onunhandledrejection && (W.log("Global Handler attached: onunhandledrejection"), this.Wt())
                ...
                this.Xt || (vt({
                    callback: function(r) {
                        ...
                        if (o && !Mn() && !u) {
                            var s = e.getClient(),
                                c = m(i) ? t.$t(r.msg, r.url, r.line, r.column) : t.Gt(kn(i, void 0, {
            ...
            }, n.prototype.Gt = function(t, n, r, i) {
        ...
        Ln = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
        Un = function() {
            function t(n) {
            ...
            return t.prototype.setupOnce = function() {
                var t = C();
                (this.ct.setTimeout && K(t, "setTimeout", this.Kt.bind(this)), this.ct.setInterval && K(t, "setInterval", this.Kt.bind(this)), this.ct.requestAnimationFrame && K(t, "requestAnimationFrame", this.Vt.bind(this)), this.ct.XMLHttpRequest && "XMLHttpRequest" in t && K(XMLHttpRequest.prototype, "send", this.Qt.bind(this)), this.ct.eventTarget) && (Array.isArray(this.ct.eventTarget) ? this.ct.eventTarget : Ln).forEach(this.Yt.bind(this))
                ...
                return function() {
                    ...
                    return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function(t) {
                        t in i && "function" == typeof i[t] && K(i, t, function(n) {
                            ...
                            return n.__sentry_original__ && (r.mechanism.data.handler = z(n.__sentry_original__)), Cn(n, r)
                        })
                    }), t.apply(this, n)
                }
            }, t.id = "TryCatch", t
        ...
        Xn = function() {
            function t(n) {
                void 0 === n && (n = {}), this.name = t.id, this.en = n.key || Fn, this.O = n.limit || Pn
            }
            return t.prototype.setupOnce = function() {
                Nt(function(n, r) {
            ...
            return t.prototype.setupOnce = function() {
                Nt(function(n) {
                    ...
                    if (Ut().getIntegration(t)) {
                        if (!Bn.navigator && !Bn.location && !Bn.document) return n;
                        var o = (null === (r = n.request) || void 0 === r ? void 0 : r.url) || (null === (i = Bn.location) || void 0 === i ? void 0 : i.href),
                            u = (Bn.document || {}).referrer,
        ...
        $n = function(t) {
            ...
            return r(n, t), n.prototype.showReportDialog = function(t) {
                void 0 === t && (t = {}), C().document && (this.pt() ? An(a(a({}, t), {
            ...
            }, n.prototype.xt = function(n) {
                var r = this.getIntegration(Hn);
                r && r.addSentryBreadcrumb(n), t.prototype.xt.call(this, n)
            }, n
        }(zt),
        Gn = [new un, new en, new Un, new Hn, new qn, new Xn, new Jn];
    var zn = {},
        Kn = C();
    Kn.Sentry && Kn.Sentry.Integrations && (zn = Kn.Sentry.Integrations);
    var Vn = a(a(a({}, zn), sn), Wn);
    return t.BrowserClient = $n, t.Hub = At, t.Integrations = Vn, t.SDK_NAME = "sentry.javascript.browser", t.SDK_VERSION = rn, t.Scope = Rt, t.Transports = Rn, t.addBreadcrumb = function(t) {
        Xt("addBreadcrumb", t)
        ...
        Xt("configureScope", t)
    }, t.defaultIntegrations = Gn, t.eventFromException = xn, t.eventFromMessage = jn, t.flush = function(t) {
        var n = Ut().getClient();
        return n ? n.flush(t) : jt.reject(!1)
    }, t.forceLoad = function() {}, t.getCurrentHub = Ut, t.getHubFromCarrier = Ft, t.init = function(t) {
